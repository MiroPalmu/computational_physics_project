...
def load_beve(filename):
    if filename == None:
        raise RuntimeError(f"failed to read beve file: '{filename}'")
...
if __name__ == "__main__":
    dump_dir = "/home/miro/repos/computational_physics_project/build/w2_bssn_uniform_grid_dump/"

    algebraic_constraint_S = load_beve(dump_dir + "algebraic_constraint_S.beve")
    algebraic_constraint_conformal_A = load_beve(dump_dir + "algebraic_constraint_conformal_A.beve")
    print(algebraic_constraint_S)
    print(algebraic_constraint_conformal_A)
